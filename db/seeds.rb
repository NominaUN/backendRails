...
Concept.create!([{concept_name: 'Salario', category: 'Devengado'},{concept_name: 'Auxilio de Transporte', category: 'Devengado'},
	...
	{concept_name: 'Intereses de Cesantías', category: 'Provisión'},{concept_name: 'Inactividad', category: 'Devengado'}])
...
Employee.create!([{document_type: 'CC', document_number: '123', first_name: 'Andrew', other_name: 'James', last_name: 'Walkan', second_surname: 'Junior',
	...
	salary: 2000000, transport_aid: false, integral_salary: false, area_id: 1, position_id: 1, contract: 'Fijo'},
	...
	salary: 1500000, transport_aid: false, integral_salary: false, area_id: 2, position_id: 2, contract: 'Fijo'},
	...
	salary: 4000000, transport_aid: false, integral_salary: false, area_id: 3, position_id: 3, contract: 'Fijo'},
	...
	salary: 900000, transport_aid: true, integral_salary: false, area_id: 4, position_id: 4, contract: 'Fijo'}])
...
Novelty.create!([{novelty_type: 'Inactividad', category: 'Devengado', novelty_value: 0, period: 1, applied: 0, description: 'Enfermedad General',
	percentage1: 100, percentage2: 66.67, percentage3: 50, employee_id: 1},{novelty_type: 'Otros', category: 'Devengado',
	novelty_value: 100000, period: 1, applied: 1, description: 'Bonificacion', percentage1: 0, percentage2: 0, percentage3: 0, employee_id: 3}])
GeneralParameter.create!([{round_type: 100, laboral_days: 5, payday: 'QUINCENAL', integral_base: 70, auto_liquidation: false}])
User.create!(email: 'admin@admin.com', nickname: 'UOne', name: 'User One', password: '12345678', tokens: nil, notifications: true, user_role: 'admin', notifications_days: 10, employee: 0)