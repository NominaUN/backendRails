class AddNotNullValidationToPaydayDetail < ActiveRecord::Migration[5.0]
  def change
	...
	change_column_null(:payday_details, :concept_id, false)
	change_column_null(:payday_details, :employee_id, false)
	change_column_null(:payday_details, :payday_master_id, false)
  end
end
