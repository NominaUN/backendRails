...
ActiveRecord::Schema.define(version: 20170420010809) do
  ...
  create_table "general_parameters", force: :cascade do |t|
    ...
    t.boolean  "auto_liquidation", null: false
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["notifications"], name: "index_users_on_notifications", using: :btree
    t.index ["notifications_days"], name: "index_users_on_notifications_days", using: :btree
    t.index ["reset_password_token"], name: "index_users_on_reset_password_token", unique: true, using: :btree
    t.index ["uid", "provider"], name: "index_users_on_uid_and_provider", unique: true, using: :btree
    t.index ["user_role"], name: "index_users_on_user_role", using: :btree
  end
